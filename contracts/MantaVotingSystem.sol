...
/**
 * @title MantaVotingSystem
 * @dev A decentralized voting system optimized for Manta Network
 * @author VoteChain Team
 */
contract MantaVotingSystem {
    struct Poll {
        string question;
        string[] options;
        uint256[] votes;
    ...
    // Events optimized for Manta Network
    event PollCreated(
    ...
    /**
     * @dev Create a new poll with enhanced features for Manta Network
     */
    function createPoll(
